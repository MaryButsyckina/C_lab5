...
namespace test
{
	...
	namespace constants
	{
		...
		const SmartPhone::RAM RAM_type_incorr = SmartPhone::RAM(2);
		...
		const int apps_corr = 10;
		const int apps_incorr = -1;
		const int apps_null = 0;

		const float usedROM_corr = 100;
		const float usedROM_incorr = -1;
		const float usedROM_null = 0;

		const int apps_incorr2 = 0;
		const float usedROM_incorr2 = 100;

		const string IMEI_corr = "447402515437650";
		const string IMEI_incorr1 = "";
		const string IMEI_incorr2 = "44740251543765";

		const int expected_avApps1 = 15;
